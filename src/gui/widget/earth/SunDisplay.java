...
public class SunDisplay extends JPanel {
  ...
  void moveSunPosition(float degrees)
    {
	  //System.out.println("sun position: " + degrees);
	  //Eric - you do not wan to to make degreePosition depend on the previous values - you get exponential changes in positions!
      degreePosition = (180-degrees) % 360;
     // degreePosition = (degrees) % 360;
      if(degreePosition < 0) {
        degreePosition += 360;
        }
